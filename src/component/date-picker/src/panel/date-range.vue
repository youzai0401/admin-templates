  ...
  export default {
    ...
    methods: {
      ...
      handleRangePick(val, close = true) {
        ...
        if (val.maxDate && val.maxDate.getHours() === 0) {
          const maxDate = val.maxDate.getTime() + ((23 * 60 + 59) * 60 + 59) * 1000;
          val.maxDate = new Date(maxDate);
        }
//        if (val.minDate && val.minDate.getHours() === 0) {
//          const minDate = val.minDate.getTime() + ((23 * 60 + 59) * 60 + 59) * 1000;
//          console.log(minDate)
//          val.minDate = new Date(minDate);
//        }
        console.log(val)
        this.maxDate = val.maxDate;
        this.minDate = val.minDate;
